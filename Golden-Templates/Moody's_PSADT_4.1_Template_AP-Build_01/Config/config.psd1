@{
    ...
    MSI = @{
        ...
        LogPathNoAdminRights = '$envAppData\Microsoft\IntuneManagementExtension\Logs\Software'
    ...
    Toolkit = @{
        ...
        LogPath = '$envProgramData\Microsoft\IntuneManagementExtension\Logs\Software'
